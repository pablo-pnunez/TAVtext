...
class LEALLA2ITM(RSTModel):
    ...
    def get_sub_model(self):
        ...
        sentence_encoding_layer = hub.KerasLayer("https://www.kaggle.com/models/google/lealla/frameworks/TensorFlow2/variations/lealla-small/versions/1", input_shape=[], dtype=tf.string, name='LEALLA')
