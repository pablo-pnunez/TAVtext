...
class BERTATT2VAL(ATT2VAL):
    ...
    def get_sub_model(self):
        ...
        if mv == "0": # Se añade la estandarización a la salida y se simplifica el modelo
            ...
            bert_emb = self.bert_model(text_in)[0]
            ...
            items_emb = tf.keras.layers.Embedding(rst_no, emb_size*2, name="all_items")
    ...
    def __create_tfdata__(self, dataframe):
        ...
        text_seqs = self.tokenizer.batch_encode_plus(text_data, max_length=self.DATASET.DATA["MAX_LEN_PADDING"], truncation=True)
